...
// const URL = `https://pixabay.com/api/?key=${KEY}&q=${usersInput}&image_type=photo&orientation=horizontal&safesearch=true`;

async function getImageToRender(usersInput, page, perPage) {
